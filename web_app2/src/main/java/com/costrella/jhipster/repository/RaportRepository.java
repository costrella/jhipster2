...
public interface RaportRepository extends JpaRepository<Raport, Long> {
    ...
    Map<String, Long> getRaportsByDate(LocalDateTime from, LocalDateTime to, Long userId);
    ...
    Map<String, Long> getRaportsByDateAndStore(Long storeId, LocalDateTime from, LocalDateTime to, Long userId);
    ...
    Map<String, Long> getRaportsByDateAndStoreAndWarehouse(Long warehouseId, Long storeId, LocalDateTime from, LocalDateTime to, Long userId);
    ...
    Map<String, Long> getRaportsByDateAndStoreAndStoreGroup(Long storeId, LocalDateTime from, LocalDateTime to, Long storegroupId, Long userId);
    ...
    Map<String, Long> getRaportsByDateAndStoreAndStoreGroupAndWarehouse(Long warehouseId, Long storeId, LocalDateTime from, LocalDateTime to, Long storegroupId, Long userId);
    ...
    Map<String, Long> getRaportsByDateAndPersonAndStore(Long idPerson, Long storeId, LocalDateTime from, LocalDateTime to, Long userId);
    ...
    Map<String, Long> getRaportsByDateAndPersonAndStoreAndWarehouse(Long warehouseId, Long idPerson, Long storeId, LocalDateTime from, LocalDateTime to, Long userId);
    ...
    Map<String, Long> getRaportsByDateAndPersonAndStoreAndStoreGroup(Long idPerson, Long storeId, LocalDateTime from, LocalDateTime to, Long storegroupId, Long userId);
    ...
    Map<String, Long> getRaportsByDateAndPersonAndStoreAndStoreGroupAndWarehouse(Long warehouseId, Long idPerson, Long storeId, LocalDateTime from, LocalDateTime to, Long storegroupId, Long userId);
    ...
    Map<String, Long> getRaportsByDateAndWarehouse(Long warehouseId, LocalDateTime from, LocalDateTime to, Long userId);
    ...
    Map<String, Long> getRaportsByDateAndStoreGroupAndWarehouse(Long warehouseId, LocalDateTime from, LocalDateTime to, Long storegroupId, Long userId);
    ...
    Map<String, Long> getRaportsByDateAndStoreGroup(LocalDateTime from, LocalDateTime to, Long storegroupId, Long userId);

    @Query("SELECT sum(raport.z_a) as z_a, sum(raport.z_b) as z_b, sum(raport.z_c) as z_c, sum(raport.z_d) as z_d, " + "sum(raport.z_e) as z_e, sum(raport.z_f) as z_f, sum(raport.z_g) as z_g, sum(raport.z_h) as z_h " +
        "from Raport raport JOIN raport.person.users u where raport.person.id = ?1 AND raport.date BETWEEN ?2 AND ?3 AND u.id = ?4")
    Map<String, Long> getRaportsByDateAndPerson(Long idPerson, LocalDateTime from, LocalDateTime to, Long userId);
    ...
    Map<String, Long> getRaportsByDateAndPersonAndWarehouse(Long warehouseId, Long idPerson, LocalDateTime from, LocalDateTime to, Long userId);
    ...
    Map<String, Long> getRaportsByDateAndPersonAndStoreGroupAndWarehouse(Long warehouseId, Long idPerson, LocalDateTime from, LocalDateTime to, Long storegroupId, Long userId);
    ...
    Map<String, Long> getRaportsByDateAndPersonAndStoreGroup(Long idPerson, LocalDateTime from, LocalDateTime to, Long storegroupId, Long userId);
    ...
    Page<Raport> getRaportsByDate(LocalDateTime from, LocalDateTime to, Long userId, Pageable pageable);
    ...
    Page<Raport> getRaportsByDateAndWarehouse(Long warehouseId, LocalDateTime from, LocalDateTime to, Long userId, Pageable pageable);
    ...
    Page<Raport> getRaportsByDateAndStoreGroup(LocalDateTime from, LocalDateTime to, Long storegroupId, Long userId, Pageable pageable);
    ...
    Page<Raport> getRaportsByDateAndStoreGroupAndWarehouse(Long warehouseId, LocalDateTime from, LocalDateTime to, Long storegroupId, Long userId, Pageable pageable);
    ...
    Page<Raport> getRaportsByDateAndPerson(Long idPerson, LocalDateTime from, LocalDateTime to, Long userId, Pageable pageable);
    ...
    Page<Raport> getRaportsByDateAndPersonAndWarehouse(Long warehouseId, Long idPerson, LocalDateTime from, LocalDateTime to, Long userId, Pageable pageable);
    ...
    Page<Raport> getRaportsByDateAndPersonAndStoreGroup(Long idPerson, LocalDateTime from, LocalDateTime to, Long storegroupId, Long userId, Pageable pageable);
    ...
    Page<Raport> getRaportsByDateAndPersonAndStoreGroupAndWarehouse(Long warehouseId, Long idPerson, LocalDateTime from, LocalDateTime to, Long storegroupId, Long userId, Pageable pageable);
    ...
    Page<Raport> getRaportsByDateAndPersonAndStore(Long idPerson, Long storeId, LocalDateTime from, LocalDateTime to, Long userId, Pageable pageable);
    ...
    Page<Raport> getRaportsByDateAndPersonAndStoreAndWarehouse(Long warehouseId, Long idPerson, Long storeId, LocalDateTime from, LocalDateTime to, Long userId, Pageable pageable);
    ...
    Page<Raport> getRaportsByDateAndPersonAndStoreAndStoreGroup(Long idPerson, Long storeId, LocalDateTime from, LocalDateTime to, Long storegroupId, Long userId, Pageable pageable);
    ...
    Page<Raport> getRaportsByDateAndPersonAndStoreAndStoreGroupAndWarehouse(Long warehouseId, Long idPerson, Long storeId, LocalDateTime from, LocalDateTime to, Long storegroupId, Long userId, Pageable pageable);
    ...
    Page<Raport> getRaportsByDateAndStore(Long storeId, LocalDateTime from, LocalDateTime to, Long userId, Pageable pageable);
    ...
    Page<Raport> getRaportsByDateAndStoreAndWarehouse(Long warehouseId, Long storeId, LocalDateTime from, LocalDateTime to, Long userId, Pageable pageable);
    ...
    Page<Raport> getRaportsByDateAndStoreAndStoreGroup(Long storeId, LocalDateTime from, LocalDateTime to, Long storegroupId, Long userId, Pageable pageable);
    ...
    Page<Raport> getRaportsByDateAndStoreAndStoreGroupAndWarehouse(Long warehouseId, Long storeId, LocalDateTime from, LocalDateTime to, Long storegroupId, Long userId, Pageable pageable);
