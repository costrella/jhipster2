(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('cechiniApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-cechiniApp-error');
                var entityKey = httpResponse.headers('X-cechiniApp-params');
                if (errorHeader) {
