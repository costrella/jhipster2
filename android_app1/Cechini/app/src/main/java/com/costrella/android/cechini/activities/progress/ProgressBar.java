package com.costrella.android.cechini.activities.progress;
...
public class ProgressBar {
    ...
    public static void showProgress(final boolean show, Context context, final View scroolView, final View mProgressView) {
